...
-- application menu from montagdude/awesome-appmenu
...
--slider.minimum = 0
--slider.maximum = 100
--sliderpopup = awful.popup(slider)
...
-- where shit actually gets drawn onto the screen
...
globalkeys = gears.table.join(
    ...
    awful.key({}, "XF86AudioMute", function() awful.spawn(confdir.."scripts/f_keys.sh mute_volume") end,
	{description = "toggle volume mute", group = "f-keys"}),
    awful.key({}, "XF86AudioLowerVolume", function() awful.spawn(confdir.."scripts/f_keys.sh volume_down") end,
	{description = "lower volume", group = "f-keys"}),
    awful.key({}, "XF86AudioRaiseVolume", function() awful.spawn(confdir.."scripts/f_keys.sh volume_up") end,
	{description = "raise volume", group = "f-keys"}),
    awful.key({}, "XF86AudioMicMute", function() awful.spawn(confdir.."scripts/f_keys.sh mute_mic") end,
	{description = "toggle mic mute", group = "f-keys"}),
    awful.key({}, "XF86MonBrightnessDown", function() awful.spawn(confdir.."scripts/f_keys.sh brightness_down") end,
